...
import { SpeakerOnIcon, SpeakerOffIcon, FileIcon, SaveIcon, UploadIcon, GlobeIcon } from './Icons';
                ...
                <form onSubmit={handleSubmit} className="flex items-end gap-2">
                    ...
                    <div className="flex items-center">
                        <button 
                            ...
                            className={`p-2 rounded-full transition-colors mr-1 ${webAccess ? 'text-cyan-400 bg-cyan-900/30' : 'text-gray-400 hover:bg-gray-700'}`}
                            title={webAccess ? "Disable Web Access" : "Enable Web Access"}
